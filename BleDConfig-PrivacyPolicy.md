...
- When you choose to sign in with Apple, I do **not** collect or store your personal information such as your name, email, or any other data. Only the authentication token provided by Apple is used internally for identity verification.
...
- Public **BleDControllers** are stored on remote server (FirebaseStorage secured by FirebaseAppCheck).
- User can manage **BleDControllers** via the app (add/update/remove).
- Public **BleDControllers** are assigned to user identifier and can be restored on different device using the same account.
- Local **BleDControllers** will get lost once app uninstalled.
- All public **BleDControllers** needs to be removed before you delete an account.
- When you uninstall the app, all locally stored data, including local **BleDControllers**, is also removed.
...
- You have the right to delete your account in the app at any time.
- You can also uninstall the app to delete all locally stored **BleDControllers**.

**6. Data Security**

- I implement reasonable security measures to protect your data on the device.
- System uses appropriate data access rules to protect app data.
